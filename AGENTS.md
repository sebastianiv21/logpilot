...
- TypeScript 5.9 + React 19 (frontend), Python 3.14 (backend) + Frontend: Vite, React Router, TanStack Query, React Hook Form, Zod, ReactMarkdown, DaisyUI, Tailwind, Sonner, Lucide React; Backend: FastAPI, Pydantic, markdown, ReportLab (014-report-followups)
